...
from fedml_api.data_preprocessing.nepal_earthquake.data_loader import load_partition_data_pandas
...
from fedml_api.standalone.fedavg.my_model_trainer_tabnet import MyModelTrainer as MyModelTrainerTabNet
...
def load_data(args, dataset_name):
    ...
    elif dataset_name == "nepal_earthquake":
        logging.info("load_data. dataset_name = %s" % dataset_name)
        train_data_num, test_data_num, train_data_global, test_data_global, \
        train_data_local_num_dict, train_data_local_dict, test_data_local_dict, \
        class_num = load_partition_data_pandas(dataset=dataset_name, data_dir=args.data_dir,
                                                  partition_method=None, partition_alpha=None,
                                                  client_number=args.client_num_in_total, batch_size=args.batch_size)
...
def create_model(args, model_name, output_dim):
    ...
    if model_name == "lr" and args.dataset == "mnist":
        ...
        model.load_model(os.path.join(args.data_dir, "tabnet_model_csv.zip"))
    return model
...
def custom_model_trainer(args, model):
    ...
    elif args.dataset == "nepal_earthquake":
        return MyModelTrainerTabNet(model)
